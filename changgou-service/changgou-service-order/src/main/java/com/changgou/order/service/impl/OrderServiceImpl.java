...
public class OrderServiceImpl implements OrderService {
     ...
     */
    @Override
    public void updateStatus(String outtradeno, String paytime, String transactionid) throws ParseException, Exception {
    ...
    public void add(Order order){
        ...
        order.setOrderStatus("0"); // 订单状态0：未完成
        ...
        order.setPayMoney(totalMoney); // 实付金额 - 优惠金额
        // 添加订单信息
